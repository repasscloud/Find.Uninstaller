#
# Module manifest for module 'Find.Uninstaller'
#
...
GUID = '4109855e-fcc4-40fa-b5e8-13b68777d6bb'
...
Description = 'PowerShell module to get the uninstall string of any installed application.
...
FileList = 'private', 'public', 'LICENSE', 'README.md', 'Find.Uninstaller.psm1', 
               'Find.Uninstaller.psd1', 'CHANGELOG.md'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'uninstall', 'remove', 'applications', 'uninstaller', 'program', 'programs', 
               'apps'
        ...
        ReleaseNotes = '- Astericks support from either end, or no ends
